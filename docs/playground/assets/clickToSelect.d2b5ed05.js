import"./modulepreload-polyfill.b7f2da20.js";import"./index.c7835f9b.js";import{s as t,r as c}from"./tool.19296855.js";import{H as r,t as o,x as d}from"./xml.7ceb4a85.js";import{P as s}from"./mobile-picker.es.0a103c63.js";var l=`<!doctype html>\r
<html lang="en">\r
\r
<head>\r
...
`;let i=[];function p(){new s(".mobile-picker",{selectedIndexes:i,onChange(e){i=e,n()},clickToSelect:!0}),n()}function n(){const e=document.querySelector(".demo-card-top .value span");e&&(e.textContent=i.join("\uFF0C"))}r.registerLanguage("typescript",o);r.registerLanguage("html",d);r.registerLanguage("scss",t);customElements.whenDefined("mdui-card").then(()=>{p(),c({html:l,css:a,ts:m}),r.highlightAll()});
