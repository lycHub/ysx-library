...
`;let i=[];function p(){new s(".mobile-picker",{selectedIndexes:i,onChange(e){i=e,n()}}),n()}function n(){const e=document.querySelector(".demo-card-top .value span");e&&(e.textContent=i.join("\uFF0C"))}r.registerLanguage("typescript",o);r.registerLanguage("html",d);r.registerLanguage("scss",t);customElements.whenDefined("mdui-card").then(()=>{p(),c({html:a,css:l,ts:m}),r.highlightAll()});
