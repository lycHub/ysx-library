import"./modulepreload-polyfill.b7f2da20.js";import"./tabs.6bc04e7b.js";import{H as i,t as c,x as s}from"./xml.7ceb4a85.js";import{s as l}from"./scss.38479186.js";import{P as a}from"./mobile-picker.es.7450b70e.js";var d=`<!doctype html>\r
<html lang="en">\r
\r
<head>\r
...
\r
\r
`;let r=[];function v(){new a(".mobile-picker",{selectedIndexes:r,onChange(e){console.log("onChange>>>",e),r=e,t()}}),t()}function t(){const e=document.querySelector(".demo-card-top .value span");e&&(e.textContent=r.join("\uFF0C"))}i.registerLanguage("typescript",c);i.registerLanguage("html",s);i.registerLanguage("scss",l);const p={html:d,css:o,ts:m};function u(){document.querySelectorAll(".demo-code-content").forEach(n=>{n.querySelector("pre code").textContent=p[n.value]})}customElements.whenDefined("mdui-card").then(()=>{v(),u(),i.highlightAll()});
