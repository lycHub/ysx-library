import"./modulepreload-polyfill.b7f2da20.js";import"./tabs.6bc04e7b.js";import{H as r,t as a,x as s}from"./xml.7ceb4a85.js";import{s as c}from"./scss.38479186.js";import{P as l}from"./mobile-picker.es.432436b2.js";var d=`<!doctype html>\r
<html lang="en">\r
\r
<head>\r
...
\r
`;let i=[];function v(){new l(".mobile-picker",{selectedIndexes:i,onChange(e){i=e,t()}}),t()}function t(){const e=document.querySelector(".demo-card-top .value span");e&&(e.textContent=i.join("\uFF0C"))}r.registerLanguage("typescript",a);r.registerLanguage("html",s);r.registerLanguage("scss",c);const p={html:d,css:o,js:m};function u(){document.querySelectorAll(".demo-code-content").forEach(n=>{n.querySelector("pre code").textContent=p[n.value]})}customElements.whenDefined("mdui-card").then(()=>{v(),u(),r.highlightAll()});
