import"./modulepreload-polyfill.b7f2da20.js";import"./tabs.e162c8ee.js";import{H as i,t as c,x as a}from"./xml.7ceb4a85.js";import{s}from"./scss.38479186.js";import{P as l}from"./mobile-picker.es.7bcb7d3c.js";var d=`<!doctype html>
<html lang="en">
...
\r
\r
`;let n=[];function v(){new l(".mobile-picker",{selectedIndexes:n,onChange(e){n=e,t()},clickToSelect:!0}),t()}function t(){const e=document.querySelector(".demo-card-top .value span");e&&(e.textContent=n.join("\uFF0C"))}i.registerLanguage("typescript",c);i.registerLanguage("html",a);i.registerLanguage("scss",s);const p={html:d,css:o,js:m};function u(){document.querySelectorAll(".demo-code-content").forEach(r=>{r.querySelector("pre code").textContent=p[r.value]})}customElements.whenDefined("mdui-card").then(()=>{v(),u(),i.highlightAll()});
