import { NodeKey } from '../../../VirtualTree/src/tree/types';
const columns = [
  {
    title: '参数',
    dataIndex: 'argument',
...
const propData = [
  ...
  },
  {
    argument: 'virtual',
    description:
      '虚拟树配置，传入则表示开启虚拟树, size是每个node高度，remain是显示多少个node, 滚动高度 = size * remain',
    type: 'VirtualConfig',
    defaultValue: '',
  },
];
...
const methodData = [
  ...
  {
    name: 'toggleExpand',
    description: '手动展开或收起节点',
    type: '(nodeKey: NodeKey, state?: boolean) => void',
  },
];
